...
message(STATUS "imu_driver: 0 messages, 1 services")
...
get_filename_component(_filename "/home/ubuntu/catkin_ws/src/imu_driver/srv/Angle.srv" NAME_WE)
add_custom_target(_imu_driver_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "imu_driver" "/home/ubuntu/catkin_ws/src/imu_driver/srv/Angle.srv" ""
)
...
_generate_srv_cpp(imu_driver
  "/home/ubuntu/catkin_ws/src/imu_driver/srv/Angle.srv"
  "${MSG_I_FLAGS}"
  ""
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/imu_driver)
  install(CODE "execute_process(COMMAND \"/usr/bin/python\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/imu_driver\")")
  # install generated code
  install(
